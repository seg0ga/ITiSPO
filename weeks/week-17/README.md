...
## Мой вариант
`variants/433/s05/week-17.json`
Там описана тема моего проекта (например, "Сервис доставки еды" или "Трекер задач").
...
## Фронтенд
- После запуска docker compose up --build интерфейс будет доступен по адресу http://localhost:8080.
- Через страницу можно:
  - посмотреть список логов
  - добавить новый лог
  - посмотреть количество логов по уровням
